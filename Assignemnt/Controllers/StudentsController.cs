    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Student != null ? 
                          ...
                          Problem("Entity set 'ITIContext.Student'  is null.");
        }
        ...
        public async Task<IActionResult> Create(Student student,int DeptId)
        {
            var depts = _context.Department.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StdName,StdAge")] Student student)
        {
            if (id != student.StdId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ITIContext.Student'  is null.");
            }
            var student = await _context.Student.FindAsync(id);
            if (student != null)
            {
